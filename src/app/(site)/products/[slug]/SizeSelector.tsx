        ...
        {selectedSize && selectedAvailable && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="flex w-full items-center justify-center rounded-full border border-olive bg-white px-8 py-3.5 text-base font-medium text-olive transition-all hover:bg-olive/10"
            >
              Order Now
            </button>
          </div>
